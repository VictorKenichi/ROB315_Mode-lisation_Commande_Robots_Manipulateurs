...
plot3([0,iE(1,1)],[0,iE(2,1)],[0,iE(3,1)],'k--', 'LineWidth', 3, 'HandleVisibility', 'off');
hold on
plot3([0,jE(1,1)],[0,jE(2,1)],[0,jE(3,1)],'k--', 'LineWidth', 3, 'HandleVisibility', 'off');
plot3([0,kE(1,1)],[0,kE(2,1)],[0,kE(3,1)],'k--', 'LineWidth', 3, 'HandleVisibility', 'off');
plot3([iE(1,1)],[iE(2,1)],[iE(3,1)],'kx', 'DisplayName', 'x_0');
plot3([jE(1,1)],[jE(2,1)],[jE(3,1)],'kv', 'DisplayName', 'y_0');
plot3([kE(1,1)],[kE(2,1)],[kE(3,1)],'ks', 'DisplayName', 'z_0');
